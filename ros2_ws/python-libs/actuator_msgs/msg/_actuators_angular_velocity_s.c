...
bool actuator_msgs__msg__actuators_angular_velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("actuator_msgs.msg._actuators_angular_velocity.ActuatorsAngularVelocity", full_classname_dest, 70) == 0);
  }
  actuator_msgs__msg__ActuatorsAngularVelocity * ros_message = _ros_message;
  {  // velocity
...
{
  /* NOTE(esteve): Call constructor of ActuatorsAngularVelocity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("actuator_msgs.msg._actuators_angular_velocity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActuatorsAngularVelocity");
