...
bool actuator_msgs__msg__actuators__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("actuator_msgs.msg._actuators.Actuators", full_classname_dest, 38) == 0);
  }
  actuator_msgs__msg__Actuators * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Actuators */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("actuator_msgs.msg._actuators");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Actuators");
