...
class Metaclass_ActuatorsLinearVelocity(type):
    """Metaclass of message 'ActuatorsLinearVelocity'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__actuators_linear_velocity
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__actuators_linear_velocity
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__actuators_linear_velocity
            cls._TYPE_SUPPORT = module.type_support_msg__msg__actuators_linear_velocity
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__actuators_linear_velocity
...
class ActuatorsLinearVelocity(metaclass=Metaclass_ActuatorsLinearVelocity):
    """Message class 'ActuatorsLinearVelocity'."""
