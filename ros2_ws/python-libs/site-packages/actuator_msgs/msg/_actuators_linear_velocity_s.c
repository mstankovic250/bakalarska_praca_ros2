...
bool actuator_msgs__msg__actuators_linear_velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("actuator_msgs.msg._actuators_linear_velocity.ActuatorsLinearVelocity", full_classname_dest, 68) == 0);
  }
  actuator_msgs__msg__ActuatorsLinearVelocity * ros_message = _ros_message;
  {  // velocity
...
{
  /* NOTE(esteve): Call constructor of ActuatorsLinearVelocity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("actuator_msgs.msg._actuators_linear_velocity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActuatorsLinearVelocity");
