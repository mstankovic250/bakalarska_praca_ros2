...
class Metaclass_UpdateFilename_Event(type):
    """Metaclass of message 'UpdateFilename_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__update_filename__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__update_filename__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__update_filename__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__update_filename__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__update_filename__event
...
class UpdateFilename_Event(metaclass=Metaclass_UpdateFilename_Event):
    """Message class 'UpdateFilename_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<pcl_msgs/UpdateFilename_Request, 1>',
        'response': 'sequence<pcl_msgs/UpdateFilename_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['pcl_msgs', 'srv'], 'UpdateFilename_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['pcl_msgs', 'srv'], 'UpdateFilename_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from pcl_msgs.srv import UpdateFilename_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, UpdateFilename_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'UpdateFilename_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from pcl_msgs.srv import UpdateFilename_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, UpdateFilename_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'UpdateFilename_Response'"
...
class Metaclass_UpdateFilename(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _update_filename.Metaclass_UpdateFilename_Event._TYPE_SUPPORT is None:
                _update_filename.Metaclass_UpdateFilename_Event.__import_type_support__()
...
class UpdateFilename(metaclass=Metaclass_UpdateFilename):
    ...
    from pcl_msgs.srv._update_filename import UpdateFilename_Event as Event
