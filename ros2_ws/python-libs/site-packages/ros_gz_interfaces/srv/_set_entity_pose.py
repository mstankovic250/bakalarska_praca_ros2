...
class Metaclass_SetEntityPose_Event(type):
    """Metaclass of message 'SetEntityPose_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_entity_pose__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_entity_pose__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_entity_pose__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_entity_pose__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_entity_pose__event
...
class SetEntityPose_Event(metaclass=Metaclass_SetEntityPose_Event):
    """Message class 'SetEntityPose_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ros_gz_interfaces/SetEntityPose_Request, 1>',
        'response': 'sequence<ros_gz_interfaces/SetEntityPose_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros_gz_interfaces', 'srv'], 'SetEntityPose_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros_gz_interfaces', 'srv'], 'SetEntityPose_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ros_gz_interfaces.srv import SetEntityPose_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetEntityPose_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetEntityPose_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ros_gz_interfaces.srv import SetEntityPose_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetEntityPose_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetEntityPose_Response'"
...
class Metaclass_SetEntityPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_entity_pose.Metaclass_SetEntityPose_Event._TYPE_SUPPORT is None:
                _set_entity_pose.Metaclass_SetEntityPose_Event.__import_type_support__()
...
class SetEntityPose(metaclass=Metaclass_SetEntityPose):
    ...
    from ros_gz_interfaces.srv._set_entity_pose import SetEntityPose_Event as Event
